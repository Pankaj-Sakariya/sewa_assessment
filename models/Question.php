...
class Question extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['topic_id', 'question_name', 'weightage_for_question', 'number_of_answer', 'is_active'], 'required'],
            [['topic_id', 'weightage_for_question', 'number_of_answer', 'correct_answer', 'is_active'], 'integer'],
